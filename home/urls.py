...
urlpatterns=[
	...
	url(r'^layout/geozipresponse/$',views.geozipresponse,name='geozipresponse'),
	url(r'^layout/populateinstallerlist/$',views.populateInstallerList,name='populateinstallerlist'),
